...
var Prototype = {
    ...
    emptyFunction: function () {}, K: function (a) {
        return a
    }
};
...
var Class = (function () {
    ...
    function c(l) {
        ...
        for (var e = 0, h = f.length; e < h; e++) {
            var k = f[e],
                j = l[k];
            if (g && Object.isFunction(j) && (j.argumentNames()[0] == "$super" || j.argumentNames()[0] == "_super")) {
                var m = j;
                j = (function (i) {
                    return function () {
...
(function (a6) {
    ...
    function am(bm, bp) {
        ...
        bp = Object.toHTML(bp);
        var bo = bm.parentNode,
            F = bo.tagName.toUpperCase();
        if (F in J.tags) {
            var bq = aD.next(bm);
    ...
    function ax(bm) {
        ...
        var i = Object.clone(al),
            F = bm.tagName.toUpperCase();
        if (aV[F]) {
    ...
    function ag(bn) {
        ...
        var F = document.createElement(bn),
            bo = F.__proto__ || F.constructor.prototype;
        F = null;
        return bo
    }
